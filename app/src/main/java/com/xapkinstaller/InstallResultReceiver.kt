...
class InstallResultReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val EXTRA_STATUS = "install_status"
        const val EXTRA_MESSAGE = "install_message"
    ...
    private fun getStatusText(status: Int): String {
        return when (status) {
            ...
            PackageInstaller.STATUS_FAILURE_CONFLICT -> "安装冲突"
            PackageInstaller.STATUS_FAILURE_INCOMPATIBLE -> "安装包不兼容"
